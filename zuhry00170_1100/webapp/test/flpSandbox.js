		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FML PERSONAL CERT FORM",
									"targetURL": "#comhmmausamyhmmamypayzuhry001701100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001701100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001701100",
								"action": "display",
								"description": "FML PERSONAL CERT FORM",
								"title": "FML PERSONAL CERT FORM",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001701100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001701100")
								}
							}
						}
					}
