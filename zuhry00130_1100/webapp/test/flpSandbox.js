		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "H LIST",
									"targetURL": "#comhmmausamyhmmamypayzuhry001301100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001301100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001301100",
								"action": "display",
								"description": "H LIST",
								"title": "H LIST",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001301100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001301100")
								}
							}
						}
					}
