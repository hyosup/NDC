/********************************************************************************************************
* Task ID       : [zuhry00130_1100]
* Task Desc     : [H LIST]
* App ID        : com.hmmausa.myhmma.mypay.zuhry001301100
* App Desc      : [H LIST]
* Developer     : GICSHR28
* Date          : 2024.04.15
* Type          : Free Style
...
sap.ui.define([
        ...
        "sap/ui/Device",
        "com/hmmausa/myhmma/mypay/zuhry001301100/model/models"
    ],
    function (UIComponent, JSONModel, Device, models) {
        "use strict";

        return UIComponent.extend("com.hmmausa.myhmma.mypay.zuhry001301100.Component", {
            metadata: {
                manifest: "json"
            },
