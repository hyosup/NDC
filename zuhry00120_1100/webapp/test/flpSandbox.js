		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My BENEFIT",
									"targetURL": "#comhmmausamyhmmamypayzuhry001201100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001201100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001201100",
								"action": "display",
								"description": "My BENEFIT",
								"title": "My BENEFIT",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001201100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001201100")
								}
							}
						}
					}
