		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAXES STATE",
									"targetURL": "#comhmmausamyhmmamypayzuhry000501100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000501100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000501100",
								"action": "display",
								"description": "TAXES STATE",
								"title": "TAXES STATE",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000501100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000501100")
								}
							}
						}
					}
