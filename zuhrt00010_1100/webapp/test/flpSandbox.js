		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ABSENCE QUOTA",
									"targetURL": "#comhmmausamyhmmamyinfozuhrt000101100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamyinfozuhrt000101100-display": {
								"semanticObject": "comhmmausamyhmmamyinfozuhrt000101100",
								"action": "display",
								"description": "ABSENCE QUOTA",
								"title": "ABSENCE QUOTA",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.myinfo.zuhrt000101100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/myinfo/zuhrt000101100")
								}
							}
						}
					}
