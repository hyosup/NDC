		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAXES FEDERAL",
									"targetURL": "#comhmmausamyhmmamypayzuhry000401100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000401100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000401100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000401100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000401100")
								}
							}
						}
					}
