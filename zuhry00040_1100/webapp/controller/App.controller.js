...
sap.ui.define(
    ...
    function(BaseController, MessageBox, Fragment) {
      ...
      return BaseController.extend("com.hmmausa.myhmma.mypay.zuhry000401100.controller.App", {
        onInit: function() {
          ...
          onPressChg: async function (oEvent) {
            ...
            if (!this.pChangeDialog) {
              ...
              this.pChangeDialog = await Fragment.load({
                id: oView.getId(),
                name: "com.hmmausa.myhmma.mypay.zuhry000401100.view.fragment.ZpayTaxFedChg",
                controller: this,
              });
