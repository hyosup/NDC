		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "LINKS",
									"targetURL": "#comhmmausamyhmmamypayzuhry001401100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001401100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001401100",
								"action": "display",
								"description": "LINKS",
								"title": "LINKS",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001401100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001401100")
								}
							}
						}
					}
