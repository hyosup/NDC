		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ANNUAL WAGE HISTORY",
									"targetURL": "#comhmmausamyhmmamypayzuhry000301100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000301100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000301100",
								"action": "display",
								"description": "ANNUAL WAGE HISTORY",
								"title": "ANNUAL WAGE HISTORY",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000301100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000301100")
								}
							}
						}
					}
