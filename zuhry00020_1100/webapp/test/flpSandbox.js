		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PAY STATEMENT",
									"targetURL": "#comhmmausamyhmmamypayzuhry000201100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000201100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000201100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000201100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000201100")
								}
							}
						}
					}
