		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TOTAL COPMENSATION",
									"targetURL": "#comhmmausamyhmmamypayzuhry001601100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001601100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001601100",
								"action": "display",
								"description": "TOTAL COPMENSATION",
								"title": "TOTAL COPMENSATION",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001601100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001601100")
								}
							}
						}
					}
