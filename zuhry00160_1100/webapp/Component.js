...
sap.ui.define([
        ...
        "com/hmmausa/myhmma/mypay/zuhry001601100/model/models"
    ],
	function (UIComponent, Device, JSONModel,ODataModel, models) {
        "use strict";

        return UIComponent.extend("com.hmmausa.myhmma.mypay.zuhry001601100.Component", {
            metadata: {
                manifest: "json"
            },
            ...
            init: function () {
				...
				// set App model
                var sUrl = '/sap/opu/odata/SAP/ZGWHRY00160_1100_SRV/';			
