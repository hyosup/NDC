		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ATTENDANCE",
									"targetURL": "#comhmmausamyhmmamyinfozuhrt000201100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamyinfozuhrt000201100-display": {
								"semanticObject": "comhmmausamyhmmamyinfozuhrt000201100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.myinfo.zuhrt000201100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/myinfo/zuhrt000201100")
								}
							}
						}
					}
