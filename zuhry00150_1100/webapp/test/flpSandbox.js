		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhmmausamyhmmamypayzuhry001501100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001501100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001501100",
								"action": "display",
								"description": "BENEFIT OVERVIEW",
								"title": "BENEFIT OVERVIEW",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001501100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001501100")
								}
							}
						}
					}
