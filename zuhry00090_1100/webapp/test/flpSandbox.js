		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MEAL TRANSACTOINS",
									"targetURL": "#comhmmausamyhmmamypayzuhry000901100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000901100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000901100",
								"action": "display",
								"description": "MEAL TRANSACTOINS",
								"title": "MEAL TRANSACTOINS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000901100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000901100")
								}
							}
						}
					}
