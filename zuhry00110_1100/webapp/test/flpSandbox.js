		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EMPLOMENT VERIFICATION",
									"targetURL": "#comhmmausamyhmmamypayzuhry001101100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001101100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001101100",
								"action": "display",
								"description": "EMPLOMENT VERIFICATION",
								"title": "EMPLOMENT VERIFICATION",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001101100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001101100")
								}
							}
						}
					}
