		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tuition Assitance Program",
									"targetURL": "#comhmmausamyhmmamypayzuhry001901100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001901100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001901100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001901100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001901100")
								}
							}
						}
					}
