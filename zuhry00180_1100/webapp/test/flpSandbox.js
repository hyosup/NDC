		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "401K WORKSHOP SIGNUP",
									"targetURL": "#comhmmausamyhmmamypayzuhry001801100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry001801100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry001801100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry001801100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry001801100")
								}
							}
						}
					}
