		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PEFECT ATTENDANCE",
									"targetURL": "#comhmmausamyhmmamyinfozuhrt000501100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamyinfozuhrt000501100-display": {
								"semanticObject": "comhmmausamyhmmamyinfozuhrt000501100",
								"action": "display",
								"description": "PEFECT ATTENDANCE",
								"title": "PEFECT ATTENDANCE",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.myinfo.zuhrt000501100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/myinfo/zuhrt000501100")
								}
							}
						}
					}
