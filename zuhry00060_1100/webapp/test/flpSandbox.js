		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAXES W2",
									"targetURL": "#comhmmausamyhmmamypayzuhry000601100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000601100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000601100",
								"action": "display",
								"description": "TAXES W2",
								"title": "TAXES W2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000601100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000601100")
								}
							}
						}
					}
