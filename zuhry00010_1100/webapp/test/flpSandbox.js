		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MY PAY",
									"targetURL": "#comhmmausamyhmmamypayzuhry000101100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000101100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000101100",
								"action": "display",
								"description": "MY PAY",
								"title": "MY PAY",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000101100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000101100")
								}
							}
						}
					}
