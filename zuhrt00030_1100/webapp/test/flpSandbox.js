		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhmmausamyhmmamyinfozuhrt000301100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamyinfozuhrt000301100-display": {
								"semanticObject": "comhmmausamyhmmamyinfozuhrt000301100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.myinfo.zuhrt000301100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/myinfo/zuhrt000301100")
								}
							}
						}
					}
