...
sap.ui.define([
        ...
        "sap/ui/Device",
        "com/hmmausa/myhmma/myinfo/zuhrt000301100/model/models"
    ],
    function (UIComponent, JSONModel, ODataModel, Device, models) {
        "use strict";

        return UIComponent.extend("com.hmmausa.myhmma.myinfo.zuhrt000301100.Component", {
            metadata: {
                manifest: "json"
            },
					...
					sample: {
                        ...
                        list2: [
							...
							{Datum: new Date('2023-06-22 15:04:00:000'),
								...
								TypeVal: 'Sale',
								LocationVal: 'GA',
								occurenceTotal: 'Contanct your supervisor regarding LOA occurences',
								colour : 'textRed'
							},
                            {Datum: new Date('2023-06-22 15:04:00:000'),
                                occurenceType: 'Attendance Incentive',
								TypeVal: 'Sale',
								LocationVal: 'GA',
								occurenceTotal: '1',
								colour : 'red'
                            ...
                            {Datum: new Date('2023-06-22 15:04:00:000'),
                                occurenceType: 'Attendance Unexcused',
								TypeVal: 'Sale',
								LocationVal: 'GA',
								occurenceTotal: '1',
								colour : '' },
