...
sap.ui.define([
        ...
        "com/hmmausa/myhmma/mypay/zuhry000701100/model/models"
    ],
    function (UIComponent, Device, JSONModel,ODataModel, models) {
        "use strict";

        return UIComponent.extend("com.hmmausa.myhmma.mypay.zuhry000701100.Component", {
            metadata: {
                manifest: "json"
            },
            ...
            init: function () {
                ...
                // set App model
                var sUrl = '/sap/opu/odata/sap/ZGWHRY00070_1100_SRV/';			
