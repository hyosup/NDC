		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAXES W2 DELIVERY METHOD",
									"targetURL": "#comhmmausamyhmmamypayzuhry000701100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzuhry000701100-display": {
								"semanticObject": "comhmmausamyhmmamypayzuhry000701100",
								"action": "display",
								"description": "TAXES W2 DELIVERY METHOD",
								"title": "TAXES W2 DELIVERY METHOD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zuhry000701100",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zuhry000701100")
								}
							}
						}
					}
